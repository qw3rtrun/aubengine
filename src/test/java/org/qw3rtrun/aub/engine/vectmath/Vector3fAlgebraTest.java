...
public class Vector3fAlgebraTest {
    ...
    private static Vector3f random() {
        return vect3f(random.nextFloat(), random.nextFloat(), random.nextFloat());
    }
    ...
    public static Collection<Object[]> params() {
        ...
        return asList(
                ...
                new Object[]{vect3f(3, 5, -3), vect3f(0, -1.5f, 10), vect3f(2, 2, 2), 3.56f},
    ...
    public void checkScalarScalability() {
        Vector3f product = a.multiply(k).product(b);
